...
namespace Game
{
	...
	void TitleScene::Initialize()
	{
		...
		//title
		{
			...
			title_tr->SetPos(Vector2(240, 80));
			title_tr->SetName(L"title_TR");
		...
		// buttons
		{
			...
			startBtn_tr->SetPos(Vector2(270, 500));
		...
		}
		{
			...
			loadBtn_tr->SetPos(Vector2(530, 500));
